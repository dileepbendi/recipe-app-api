...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list of recipes limited to the user"""
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(
            email="newtestuser@example.com", password="testpass123"
        )
        recipe = create_recipe(user=self.user)
    ...
    def test_recipe_other_users_error(self):
        """Test trying to delete other user's recipe results in error"""
        new_user = create_user(
    ...
    def test_creating_recipe_with_exixting_tags(self):
    ...
    def test_create_tag_on_update(self):
        """Test create a tag while updating a recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_ingredient_on_update(self):
        """Test create an ingredient while updating a recipe"""
        recipe = create_recipe(user=self.user)
